...
# Aufruf:   docker build --tag juergenzimmermann/mitglied:2026.4.1-hardened .
#               ggf. --no-cache
#
...
#
#           docker debug juergenzimmermann/mitglied:2026.4.1-hardened
#           docker scout sbom juergenzimmermann/mitglied:2026.4.1-hardened
#           docker scout cves juergenzimmermann/mitglied:2026.4.1-hardened
#           docker save juergenzimmermann/mitglied:2026.4.1-hardened > mitglied.tar
...
LABEL org.opencontainers.image.title="mitglied" \
    org.opencontainers.image.description="Appserver mitglied mit Basis-Image Trixie hardened" \
